...
var STATE_TO_MARKET = { "Texas" : "Dallas",
    "Colorado" : "Denver",
    "Georgia" : "Atlanta"};
...
function mapCityToState(profits_data, g, projection) {
        ...
        .enter().append("path")
          ...
          .on("mouseover", function(d) {      
              ...
              tooltip_div.transition()
                  .duration(200)
                  .style("opacity", .9);
              tooltip_div.html("Profit: " + profits_data[STATE_TO_MARKET[d.properties.name]])
